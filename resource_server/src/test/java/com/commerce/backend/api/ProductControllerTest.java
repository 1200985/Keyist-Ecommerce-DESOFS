...
class ProductControllerTest {
        ...
        void it_should_get_all_product_variants() throws Exception {
                ...
                given(productService.getAll(page, size, sort, category, minPrice, maxPrice, color))
                                .willReturn(productVariantResponses);
                ...
                then(result.getResponse().getContentAsString())
                                .isEqualTo(objectMapper.writeValueAsString(productVariantResponses));
        }
        ...
        void it_should_get_product_by_url() throws Exception {
                ...
                then(result.getResponse().getContentAsString())
                                .isEqualTo(objectMapper.writeValueAsString(productDetailsResponse));
        }
        ...
        void it_should_get_related_product_by_url() throws Exception {
                ...
                then(result.getResponse().getContentAsString())
                                .isEqualTo(objectMapper.writeValueAsString(productResponseList));
        }
        ...
        void it_should_get_most_selling_product() throws Exception {
                ...
                then(result.getResponse().getContentAsString())
                                .isEqualTo(objectMapper.writeValueAsString(productVariantResponseList));
        }
