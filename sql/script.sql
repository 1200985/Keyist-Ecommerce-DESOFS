...
create table color (
    ...
    constraint color_hex_uindex unique (hex),
    constraint color_name_uindex unique (name)
);
...
-- Insert Role data
INSERT INTO
    role (name, date_created, last_updated)
VALUES
    ('USER', NOW(), NOW());
...
create index discount_id on cart (discount_id);
...
create index cart_id on cart_item (cart_id);
...
create index discount_id on orders (discount_id);
...
VALUES
    (
        ...
        '$2a$04$v8DNBoc36pw4c7b7Xyq/aeSpGneF9WciZUI9FibVz0neksUcPBXVS',
        'read,write',
...
INSERT INTO
    keyist.product_category (id, name)
VALUES
    (1, 'Test');

INSERT INTO
    keyist.color (id, name, hex)
VALUES
    (1, 'red', '#ff144b');
